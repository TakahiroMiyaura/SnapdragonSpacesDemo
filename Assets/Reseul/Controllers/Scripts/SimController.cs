...
public class SimController : MonoBehaviour
{
    ...
    private MyCustomDeviceState state;
    ...
    private void FixedUpdate()
    {
        ...
        if (isPressed)
            InputSystem.QueueDeltaStateEvent(InputSystem.GetDevice<MyCustomDevice>().TouchScreenDelta, touchScreen * 10,
                Time.realtimeSinceStartup);

        InputSystem.QueueStateEvent(InputSystem.GetDevice<MyCustomDevice>(), state);
    }
#endif
